...
us_capitals.each_with_index do |x, index|
	...
	deck1.cards << Card.create(question: x[0], choice1: capitals1.shuffle.shift, choice2: capitals1.shuffle.shift, choice3: capitals1.shuffle.shift, answer: x[1])
end
...
world_capitals.each_with_index do |x, index|
	...
	deck2.cards << Card.create(question: x[0], choice1: capitals2.shuffle.shift, choice2: capitals2.shuffle.shift, choice3: capitals2.shuffle.shift, answer: x[1])
end
...
ruby_terms.each_with_index do |x, index|
	...
	deck3.cards << Card.create(question: x[0], choice1: terms.shuffle.shift, choice2: terms.shuffle.shift, choice3: terms.shuffle.shift, answer: x[1])
end
...
dbc_students.each_with_index do |x, index|
	...
	deck4.cards << Card.create(question: x[0], choice1: cohorts.shuffle.shift, choice2: cohorts.shuffle.shift, choice3: cohorts.shuffle.shift, answer: x[1])
end
