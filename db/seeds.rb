...
us_capitals.each_with_index do |x, index|
	...
	capitals1.delete_if {|word| word == x[1]}
	shuffled_capitals = capitals1.shuffle
	deck1.cards << Card.create(question: x[0], choice1: capitals1.shift, choice2: capitals1.shift, choice3: capitals1.shift, answer: x[1])
	p deck1.cards
end
...
world_capitals.each_with_index do |x, index|
	...
	capitals2.delete_if {|word| word == x[1]}
	shuffled_capitals = capitals2.shuffle
	deck2.cards << Card.create(question: x[0], choice1: shuffled_capitals.shift, choice2: shuffled_capitals.shift, choice3: shuffled_capitals.shift, answer: x[1])
end
...
ruby_terms.each_with_index do |x, index|
	...
	ruby_terms.delete_if {|word| word == x[1]}
	shuffled_terms = terms.shuffle
	deck3.cards << Card.create(question: x[0], choice1: shuffled_terms.shift, choice2: shuffled_terms.shift, choice3: shuffled_terms.shift, answer: x[1])
end
...
dbc_students.each_with_index do |x, index|
	...
	cohorts.delete_if {|word| word == x[1]}
	shuffled_cohorts = cohorts.shuffle
	deck4.cards << Card.create(question: x[0], choice1: shuffled_cohorts.shift, choice2: shuffled_cohorts.shift, choice3: shuffled_cohorts.shift, answer: x[1])
end
